...
3. From the root of the cloned repo where the .sln file is, run: `cf push wcfsample -s windows2012R2 -b binary_buildpack --health-check-type none -p ./Hello.Service.IIS/`
